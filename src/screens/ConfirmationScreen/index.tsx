    ...
    return (
        <View style={styles.container}>
            <View style={{ alignItems: 'center', paddingBottom: 18 }}>
                ...
                <Text style={styles.normalText}>Your booking number is <Text style={{ fontWeight: 'bold' }}>123123123</Text></Text>
                <Text style={[styles.normalText, { fontSize: 18 }]}>Your confirmation email has been sent to{'\n'}<Text style={{ fontWeight: 'bold' }}>areebvohra@gmail.com</Text></Text>
